...
#'
#' The function \code{\link{tableplot}} is used to create a tableplot. Tableplots can also be designed by the GUI \code{\link{tableGUI}}. Other useful functions are
#' \itemize{
