...
The result is illustrated in Figure~\ref{fig2}. 
...
The percentages near the vertical axis indicate which subset of the data in terms of units (row) is depicted. The range from 0\% to 100\% in Figure~\ref{fig2} means that all units of the data are plotted. 
