...
The function {\tt changeTabplot} is used to make minor changes to a {\tt tabplot} object. Suppose we want the columns in the order of \ref{fig:tp2}, and we want to change all color palettes to default starting with the first color.
...
\end{Sinput}
\end{Schunk}
A pratical work flow by using the GUI is:
\begin{enumerate}
