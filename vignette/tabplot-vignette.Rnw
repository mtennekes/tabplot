...
\begin{figure}[htp]
<<chunk2, fig.height=7, fig.width=10, dev='pdf'>>=
tableplot(diamonds)
@
...
\begin{figure}[!htp]
<<chunk3, fig.height=7, fig.width=10>>=
tableplot(diamonds, 
...
\begin{figure}[!htp]
<<chunk4, fig.height=5, fig.width=10, tidy=FALSE>>=
tableplot(diamonds, select=c(carat, price, cut, color, 
...
\begin{figure}[!htp]
<<chunk7, fig.height=5, fig.width=10>>=
...
\begin{figure}[htp]
<<chunk5, fig.height=3.5, fig.width=10>>=
tablePalettes()
@
...
\begin{figure}[htp]
<<chunk6, fig.height=7, fig.width=10>>=
...
<<chunk9, size="scriptsize", fig.keep='none'>>=
summary(tab)
plot(tab)
@
...
\begin{figure}[htp]
<<chunk10, fig.height=7, fig.width=10>>=
tab2 <- tableChange(tab, 
