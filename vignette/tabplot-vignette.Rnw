...
<<chunk1,  message=FALSE,  results='hide'>>=
require(ggplot2)
data(diamonds)
## add some NA's
...
\begin{figure}[htp]
<<chunk2,  message=FALSE, results='hide', fig.height=6.5, fig.width=10, dev='pdf'>>=
tableplot(diamonds)
@
...
\begin{figure}[!htp]
<<chunk3,  results='hide', fig.height=6.5, fig.width=10, tidy=TRUE, tidy.opts=list(width.cutoff=40)>>=
...
\begin{figure}[!htp]
<<chunk4,  results='hide', fig.height=6.5, fig.width=10, tidy=TRUE, tidy.opts=list(width.cutoff=40)>>=
...
\begin{figure}[!htp]
<<chunk5,  results='hide', fig.height=6.5, fig.width=10>>=
...
\begin{figure}[htp]
<<chunk7,  results='hide', fig.height=6.5, fig.width=10, tidy=TRUE, tidy.opts=list(width.cutoff=40)>>=
...
<<chunk8,  message=FALSE,  results='hide', tidy=TRUE, tidy.opts=list(width.cutoff=40)>>=
diamonds$carat_class <- cut(diamonds$carat, breaks=pretty(diamonds$carat, n=20))
diamonds$price_class <- cut(diamonds$price, breaks=pretty(diamonds$price, n=100))
@
...
\begin{figure}[htp]
<<chunk9,  results='hide', fig.height=6.5, fig.width=10, tidy=TRUE, tidy.opts=list(width.cutoff=40)>>=
...
<<chunk_pre, tidy=TRUE, tidy.opts=list(width.cutoff=40)>>=
...
<<chunk_pre2, tidy=TRUE, tidy.opts=list(width.cutoff=40)>>=
system.time({
...
<<chunk12, size="scriptsize", fig.keep='none'>>=
summary(tab)
plot(tab)
@
...
\begin{figure}[htp]
<<chunk10,  results='hide', fig.height=6.5, fig.width=10, tidy=TRUE, tidy.opts=list(width.cutoff=40)>>=
...
\begin{figure}[htp]
<<chunk13, fig.height=6.5, fig.width=10, tidy=TRUE, tidy.opts=list(width.cutoff=40)>>=
...
<<chunk14, tidy=TRUE, tidy.opts=list(width.cutoff=40)>>=
