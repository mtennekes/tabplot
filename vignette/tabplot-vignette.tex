...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{tableplot}\hlstd{(diamonds)}
\end{alltt}
\end{kframe}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{diamonds}\hlopt{$}\hlstd{carat_class} \hlkwb{<-} \hlkwd{num2fac}\hlstd{(diamonds}\hlopt{$}\hlstd{carat,}
    \hlkwc{n} \hlstd{=} \hlnum{20}\hlstd{)}
\hlstd{diamonds}\hlopt{$}\hlstd{price_class} \hlkwb{<-} \hlkwd{num2fac}\hlstd{(diamonds}\hlopt{$}\hlstd{price,}
    \hlkwc{n} \hlstd{=} \hlnum{100}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
