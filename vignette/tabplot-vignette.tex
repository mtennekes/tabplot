...
\begin{flushleft}
\ttfamily\noindent
\hlfunctioncall{tableplot}\hlkeyword{(}\hlsymbol{diamonds}\hlkeyword{,}{\ }\hlargument{select}{\ }\hlargument{=}{\ }\hlfunctioncall{c}\hlkeyword{(}\hlsymbol{carat}\hlkeyword{,}{\ }\hlsymbol{price}\hlkeyword{,}{\ }\hlsymbol{cut}\hlkeyword{,}{\ }\hlsymbol{color}\hlkeyword{,}{\ }\hlsymbol{clarity}\hlkeyword{)}\hlkeyword{,}{\ }\hlargument{sortCol}{\ }\hlargument{=}{\ }\hlsymbol{price}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
...
\begin{flushleft}
\ttfamily\noindent
\hlfunctioncall{tableplot}\hlkeyword{(}\hlsymbol{diamonds}\hlkeyword{,}{\ }\hlargument{select}{\ }\hlargument{=}{\ }\hlfunctioncall{c}\hlkeyword{(}\hlsymbol{carat}\hlkeyword{,}{\ }\hlsymbol{price}\hlkeyword{,}{\ }\hlsymbol{cut}\hlkeyword{,}{\ }\hlsymbol{color}\hlkeyword{,}{\ }\hlsymbol{clarity}\hlkeyword{)}\hlkeyword{,}{\ }\hlargument{sortCol}{\ }\hlargument{=}{\ }\hlsymbol{price}\hlkeyword{,}{\ }\hlargument{from}{\ }\hlargument{=}{\ }\hlnumber{0}\hlkeyword{,}{\ }\hlargument{to}{\ }\hlargument{=}{\ }\hlnumber{5}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
...
\begin{flushleft}
\ttfamily\noindent
\hlfunctioncall{tableplot}\hlkeyword{(}\hlsymbol{diamonds}\hlkeyword{,}{\ }\hlargument{select}{\ }\hlargument{=}{\ }\hlnumber{1}\hlkeyword{:}\hlnumber{7}\hlkeyword{,}{\ }\hlargument{fontsize}{\ }\hlargument{=}{\ }\hlnumber{14}\hlkeyword{,}{\ }\hlargument{legend.lines}{\ }\hlargument{=}{\ }\hlnumber{8}\hlkeyword{,}{\ }\hlargument{title}{\ }\hlargument{=}{\ }\hlstring{"{}{}Shine{\ }on{\ }you{\ }crazy{\ }Diamond"{}{}}\hlkeyword{,}{\ }\hlargument{fontsize.title}{\ }\hlargument{=}{\ }\hlnumber{18}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
\end{kframe}\includegraphics[width=\maxwidth]{figure/chunk8} 
\end{knitrout}
...
\begin{flushleft}
\ttfamily\noindent
\hlsymbol{tab2}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlfunctioncall{tableChange}\hlkeyword{(}\hlsymbol{tab}\hlkeyword{,}{\ }\hlargument{select\usebox{\hlnormalsizeboxunderscore}string}{\ }\hlargument{=}{\ }\hlfunctioncall{c}\hlkeyword{(}\hlstring{"{}{}carat"{}{}}\hlkeyword{,}{\ }\hlstring{"{}{}price"{}{}}\hlkeyword{,}{\ }\hlstring{"{}{}cut"{}{}}\hlkeyword{,}{\ }\hlstring{"{}{}color"{}{}}\hlkeyword{,}{\ }\hlstring{"{}{}clarity"{}{}}\hlkeyword{)}\hlkeyword{,}{\ }\hlargument{pals}{\ }\hlargument{=}{\ }\hlfunctioncall{list}\hlkeyword{(}\hlstring{"{}{}Set1(2)"{}{}}\hlkeyword{)}\hlkeyword{)}\hspace*{\fill}\\
\hlstd{}\hlfunctioncall{plot}\hlkeyword{(}\hlsymbol{tab2}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
\end{kframe}\includegraphics[width=\maxwidth]{figure/chunk11} 
\end{knitrout}
...
\begin{flushleft}
\ttfamily\noindent
\hlfunctioncall{tableSave}\hlkeyword{(}\hlsymbol{tab}\hlkeyword{,}{\ }\hlargument{filename}{\ }\hlargument{=}{\ }\hlstring{"{}{}diamonds.png"{}{}}\hlkeyword{,}{\ }\hlargument{width}{\ }\hlargument{=}{\ }\hlnumber{5}\hlkeyword{,}{\ }\hlargument{height}{\ }\hlargument{=}{\ }\hlnumber{3}\hlkeyword{,}{\ }\hlargument{fontsize}{\ }\hlargument{=}{\ }\hlnumber{6}\hlkeyword{,}{\ }\hlargument{legend.lines}{\ }\hlargument{=}{\ }\hlnumber{6}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
\end{kframe}
\end{knitrout}
