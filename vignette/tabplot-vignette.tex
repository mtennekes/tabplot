...
\hlstd{}\hlfunctioncall{data}\hlkeyword{(}\hlsymbol{diamonds}\hlkeyword{)}\hspace*{\fill}\\
\hlstd{}\hlcomment{\usebox{\hlnormalsizeboxhash}\usebox{\hlnormalsizeboxhash}{\ }add{\ }some{\ }NA\usebox{\hlnormalsizeboxsinglequote}s}\hspace*{\fill}\\
\hlstd{}\hlfunctioncall{is.na}\hlkeyword{(}\hlsymbol{diamonds}\hlkeyword{\usebox{\hlnormalsizeboxdollar}}\hlsymbol{price}\hlkeyword{)}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlsymbol{diamonds}\hlkeyword{\usebox{\hlnormalsizeboxdollar}}\hlsymbol{cut}{\ }=={\ }\hlstring{"{}{}Ideal"{}{}}\hspace*{\fill}\\
\hlstd{}\hlfunctioncall{is.na}\hlkeyword{(}\hlsymbol{diamonds}\hlkeyword{\usebox{\hlnormalsizeboxdollar}}\hlsymbol{cut}\hlkeyword{)}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlkeyword{(}\hlfunctioncall{runif}\hlkeyword{(}\hlfunctioncall{nrow}\hlkeyword{(}\hlsymbol{diamonds}\hlkeyword{)}\hlkeyword{)}{\ }\hlkeyword{\usebox{\hlnormalsizeboxgreaterthan}}{\ }\hlnumber{0.8}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
\end{kframe}
\end{knitrout}
...
\begin{flushleft}
\ttfamily\noindent
\hlfunctioncall{tableplot}\hlkeyword{(}\hlsymbol{diamonds}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
...
\begin{flushleft}
\ttfamily\noindent
\hlfunctioncall{tableplot}\hlkeyword{(}\hlsymbol{diamonds}\hlkeyword{,}{\ }\hlargument{select}{\ }\hlargument{=}{\ }\hlfunctioncall{c}\hlkeyword{(}\hlsymbol{carat}\hlkeyword{,}{\ }\hlsymbol{price}\hlkeyword{,}{\ }\hlsymbol{cut}\hlkeyword{,}{\ }\hlsymbol{color}\hlkeyword{,}{\ }\hlsymbol{clarity}\hlkeyword{)}\hlkeyword{,}\hspace*{\fill}\\
\hlstd{}{\ }{\ }{\ }{\ }\hlargument{sortCol}{\ }\hlargument{=}{\ }\hlsymbol{price}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
...
\begin{flushleft}
\ttfamily\noindent
\hlfunctioncall{tableplot}\hlkeyword{(}\hlsymbol{diamonds}\hlkeyword{,}{\ }\hlargument{select}\hlargument{=}\hlfunctioncall{c}\hlkeyword{(}\hlsymbol{carat}\hlkeyword{,}{\ }\hlsymbol{price}\hlkeyword{,}{\ }\hlsymbol{cut}\hlkeyword{,}{\ }\hlsymbol{color}\hlkeyword{,}\hspace*{\fill}\\
\hlstd{}{\ }{\ }{\ }{\ }{\ }{\ }{\ }{\ }{\ }{\ }{\ }{\ }{\ }{\ }{\ }{\ }{\ }{\ }{\ }{\ }{\ }{\ }{\ }{\ }{\ }\hlsymbol{clarity}\hlkeyword{)}\hlkeyword{,}{\ }\hlargument{sortCol}\hlargument{=}\hlsymbol{price}\hlkeyword{,}{\ }\hlargument{from}\hlargument{=}\hlnumber{0}\hlkeyword{,}{\ }\hlargument{to}\hlargument{=}\hlnumber{5}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
...
\begin{flushleft}
\ttfamily\noindent
\hlfunctioncall{tableplot}\hlkeyword{(}\hlsymbol{diamonds}\hlkeyword{,}{\ }\hlargument{subset}{\ }\hlargument{=}{\ }\hlsymbol{price}{\ }\hlkeyword{\usebox{\hlnormalsizeboxlessthan}}{\ }\hlnumber{5000}{\ }\hlkeyword{\usebox{\hlnormalsizeboxand}}{\ }\hlsymbol{cut}{\ }=={\ }\hlstring{"{}{}Premium"{}{}}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
...
\begin{flushleft}
\ttfamily\noindent
\hlfunctioncall{tablePalettes}\hlkeyword{(}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
...
\begin{flushleft}
\ttfamily\noindent
\hlfunctioncall{tableplot}\hlkeyword{(}\hlsymbol{diamonds}\hlkeyword{,}{\ }\hlargument{pals}{\ }\hlargument{=}{\ }\hlfunctioncall{list}\hlkeyword{(}\hlstring{"{}{}Set1(7)"{}{}}\hlkeyword{,}{\ }\hlstring{"{}{}Set5"{}{}}\hlkeyword{,}{\ }\hlfunctioncall{rainbow}\hlkeyword{(}\hlnumber{8}\hlkeyword{)}\hlkeyword{)}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
...
\begin{flushleft}
\ttfamily\noindent
\hlsymbol{tab}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlfunctioncall{tableplot}\hlkeyword{(}\hlsymbol{diamonds}\hlkeyword{,}{\ }\hlargument{plot}{\ }\hlargument{=}{\ }\hlnumber{FALSE}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
\end{kframe}
\end{knitrout}
...
\begin{flushleft}
\ttfamily\noindent
\hlfunctioncall{summary}\hlkeyword{(}\hlsymbol{tab}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
\begin{verbatim}
...
\begin{flushleft}
\ttfamily\noindent
\hlfunctioncall{plot}\hlkeyword{(}\hlsymbol{tab}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
\end{kframe}\includegraphics[width=\maxwidth]{figure/chunk9} 
\end{knitrout}
...
\begin{flushleft}
\ttfamily\noindent
\hlsymbol{tab2}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlfunctioncall{tableChange}\hlkeyword{(}\hlsymbol{tab}\hlkeyword{,}{\ }\hlargument{colNames}{\ }\hlargument{=}{\ }\hlfunctioncall{c}\hlkeyword{(}\hlstring{"{}{}carat"{}{}}\hlkeyword{,}{\ }\hlstring{"{}{}price"{}{}}\hlkeyword{,}{\ }\hlstring{"{}{}cut"{}{}}\hlkeyword{,}{\ }\hlstring{"{}{}color"{}{}}\hlkeyword{,}\hspace*{\fill}\\
\hlstd{}{\ }{\ }{\ }{\ }\hlstring{"{}{}clarity"{}{}}\hlkeyword{)}\hlkeyword{,}{\ }\hlargument{pals}{\ }\hlargument{=}{\ }\hlfunctioncall{list}\hlkeyword{(}\hlstring{"{}{}Set1(2)"{}{}}\hlkeyword{)}\hlkeyword{)}\hspace*{\fill}\\
\hlstd{}\hlfunctioncall{plot}\hlkeyword{(}\hlsymbol{tab2}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
...
\begin{flushleft}
\ttfamily\noindent
\hlfunctioncall{tableSave}\hlkeyword{(}\hlsymbol{tab}\hlkeyword{,}{\ }\hlargument{filename}{\ }\hlargument{=}{\ }\hlstring{"{}{}diamonds.png"{}{}}\hlkeyword{,}{\ }\hlargument{width}{\ }\hlargument{=}{\ }\hlnumber{5}\hlkeyword{,}{\ }\hlargument{height}{\ }\hlargument{=}{\ }\hlnumber{3}\hlkeyword{,}\hspace*{\fill}\\
\hlstd{}{\ }{\ }{\ }{\ }\hlargument{fontsize}{\ }\hlargument{=}{\ }\hlnumber{6}\hlkeyword{,}{\ }\hlargument{legend.lines}{\ }\hlargument{=}{\ }\hlnumber{6}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
\end{kframe}
\end{knitrout}
